                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <form action="{{ route('posts.destroy',$post->id) }}" method="POST">
                                    ...
                                    <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('posts.show',$post->id) }}">
                                    ...
                                    <a href="{{ route('posts.edit',$post->id) }}" class="text-indigo-600 hover:text-indigo-900 text-gray-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
